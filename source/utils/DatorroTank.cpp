...
#include "DatorroTank.h"

namespace Toro {
    void DatorroTank::prepareToPlay(int samplesPerBlockExpected, double sampleRate) {
    ...
    std::tuple<float, float> DatorroTank::processSample(float in) {
    ...
    std::tuple<float, float> DatorroTank::tap() {
