...
#include "LexiconTank.h"

namespace Toro {
    void LexiconTank::prepareToPlay(int samplesPerBlockExpected, double sampleRate) {
    ...
    std::tuple<float, float> LexiconTank::processSample(float leftLeg, float rightLeg) noexcept {

        float left = leftLeg + m_prevR;
    ...
    std::tuple<float, float> LexiconTank::tap() {
